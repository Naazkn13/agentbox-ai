...
class OpenCodeAdapter(PlatformAdapter):
    ...
    def _build_instructions_block(self) -> str:
        return (
            ...
            "## @agentkit-task: Workflow Protocol\n"
            "When a message starts with `@agentkit-task:`, activate the full AgentKit workflow "
            "by running these CLI commands **from the project root** at each phase transition:\n\n"
            "```\n"
